...
func TestSimulationUnreachableFencesTarget(t *testing.T) {
...
func TestSimulationPartitionKeepsBothActive(t *testing.T) {
	r := NewPriorityResolver([]string{"cluster1-fis", "cluster2-fis"})
	r.UpdateReachability("cluster1-fis", true)
	r.UpdateReachability("cluster2-fis", true)
	r.UpdateSubmarinerStatus(true)
	...
	if c2.Role != RoleActive || !c2.AcceptTraffic || !c2.PartitionDetected {
